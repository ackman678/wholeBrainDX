function batchFetchLocationProps(filelist,region, datafilename)
%wbatchFetchLocationProps - A wrapper and output generator for getting information on active pixel fraction per location and by 'active' and 'non-active' periods during the movie, after 'locationData' data structure has been returned and saved into 'region' from wholeBrain_activeFraction.m
